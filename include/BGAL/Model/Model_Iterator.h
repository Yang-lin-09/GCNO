...
public:
  ...
  inline bool operator!=(const int &fit) const { return !(_cursor == fit); }
  inline bool operator<=(const _Face_Iterator &fit) const {
    return (*this < fit || *this == fit);
  }
  inline bool operator>=(const _Face_Iterator &fit) const {
  ...
  inline int id() const { return _cursor; }
  ~_Face_Iterator();
...
public:
  ...
  inline bool operator!=(const int &vit) const { return !(_cursor == vit); }
  inline bool operator<=(const _Vertex_Iterator &vit) const {
    return (*this < vit || *this == vit);
  }
  inline bool operator>=(const _Vertex_Iterator &vit) const {
...
public:
  ...
  inline bool operator!=(const int &eit) const { return !(_cursor == eit); }
  inline bool operator<=(const _Edge_Iterator &eit) const {
    return (*this < eit || *this == eit);
  }
  inline bool operator>=(const _Edge_Iterator &eit) const {
...
public:
  ...
  inline bool operator!=(const int &fvit) const { return !(_cursor == fvit); }
  inline bool operator<=(const _FV_Iterator &fvit) const {
    return (*this < fvit || *this == fvit);
  }
  inline bool operator>=(const _FV_Iterator &fvit) const {
  ...
  inline int id() const { return _model->face_(_fid)[_cursor]; }
  inline int fid() const { return _fid; }
  ~_FV_Iterator();
...
class _FE_Iterator {
public:
  _FE_Iterator(const _ManifoldModel *in_model, const int &in_fid,
               const int &in_cursor);
  ...
  inline bool operator!=(const int &feit) const { return !(_cursor == feit); }
  inline bool operator<=(const _FE_Iterator &feit) const {
    return (*this < feit || *this == feit);
  }
  inline bool operator>=(const _FE_Iterator &feit) const {
  ...
  inline int id() const { return _eid; }
  inline int fid() const { return _fid; }
  ~_FE_Iterator();
...
class _FF_Iterator {
public:
  _FF_Iterator(const _ManifoldModel *in_model, const int &in_fid,
               const int &in_cursor);
  ...
  inline bool operator!=(const int &ffit) const { return !(_cursor == ffit); }
  inline bool operator<=(const _FF_Iterator &ffit) const {
    return (*this < ffit || *this == ffit);
  }
  inline bool operator>=(const _FF_Iterator &ffit) const {
  ...
  inline int id() const { return _model->edge_(_eid)._id_face; }
  inline int fid() const { return _fid; }
  ~_FF_Iterator();
...
class _VV_Iterator {
public:
  _VV_Iterator(const _ManifoldModel *in_model, const int &in_vid,
               const int &in_cursor);
  ...
  inline bool operator!=(const int &vvit) const { return !(_cursor == vvit); }
  inline bool operator<=(const _VV_Iterator &vvit) const {
    return (*this < vvit || *this == vvit);
  }
  inline bool operator>=(const _VV_Iterator &vvit) const {
  ...
  inline int id() const { return _model->edge_(_eid)._id_right_vertex; }
  inline int vid() const { return _vid; }
  ~_VV_Iterator();
...
class _VE_Iterator {
public:
  _VE_Iterator(const _ManifoldModel *in_model, const int &in_vid,
               const int &in_cursor);
  ...
  inline bool operator!=(const int &veit) const { return !(_cursor == veit); }
  inline bool operator<=(const _VE_Iterator &veit) const {
    return (*this < veit || *this == veit);
  }
  inline bool operator>=(const _VE_Iterator &veit) const {
...
class _VF_Iterator {
public:
  _VF_Iterator(const _ManifoldModel *in_model, const int &in_vid,
               const int &in_cursor);
  ...
  inline bool operator!=(const int &vfit) const { return !(_cursor == vfit); }
  inline bool operator<=(const _VF_Iterator &vfit) const {
    return (*this < vfit || *this == vfit);
  }
  inline bool operator>=(const _VF_Iterator &vfit) const {
