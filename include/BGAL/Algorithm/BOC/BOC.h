...
public:
  enum class _Sign { NegativE, ZerO, PositivE, FaileD };
  static inline double rand_() { return double(rand() / (RAND_MAX + 1.0)); }
  ...
  static inline double precision_() { return _precision; }
  //  static int search_files_(const std::string &path, const std::string &ext,
